...
public class DiningPhilosopherSolution {
    ...
    public class Philosopher implements Runnable {
        ...
        public Philosopher(int name, int n, ChopStick left, ChopStick right) {
            this.name = name;
            this.left = left;
            this.right = right;
            this.n = n;
    ...
    public void play(int n) {
        ...
        int k = 0;
        for(int i=0; i<n; i++) {
            philosophers[i] = new Philosopher(i, n, sticks[i], sticks[Math.floorMod(i - 1, n)]);
    ...
    public static void main(String args[]) {
        DiningPhilosopherSolution p = new DiningPhilosopherSolution();
